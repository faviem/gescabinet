<?php
// src/BZ/ModelBundle/Entity/PieceNote.php
...
/**
* BZ\ModelBundle\Entity\PieceNote
*
* @ORM\Table(name="piecenote")
* @ORM\Entity(repositoryClass="BZ\ModelBundle\Repository\PieceNoteRepository")
...
class PieceNote
{
    ...
    /**
    * @ORM\ManyToOne(targetEntity="BZ\ModelBundle\Entity\NoteRedigee", inversedBy="piecenotes")
...
//            $this->removeUpload();
    ...
    //            $this->setFile($file);
            ...
            // Et on génère l'attribut alt de la balise <PieceNote>, à la valeur du nom du fichier sur le PC de l'internaute
        ...
        */
        ...
        {
        return 'uploads/PieceNote/'.$this->getId().'.'.$this->getUrl();
        }
        /**
