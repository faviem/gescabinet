<?php
// src/BZ/ModelBundle/Entity/PhotoPersonnel.php
...
/**
* BZ\ModelBundle\Entity\PhotoPersonnel
*
* @ORM\Table(name="photopersonnel")
* @ORM\Entity(repositoryClass="BZ\ModelBundle\Repository\PhotoPersonnelRepository")
...
//            $this->removeUpload();
    ...
    //            $this->setFile($file);
            ...
            // Et on génère l'attribut alt de la balise <PhotoPersonnel>, à la valeur du nom du fichier sur le PC de l'internaute
        ...
        */
        ...
        {
        return 'uploads/PhotoPersonnel/'.$this->getId().'.'.$this->getUrl();
        }
        /**
