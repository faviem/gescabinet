 ...
 * AdversairePhysique
 *
 * @ORM\Table(name="adversairephysique")
 * @ORM\Entity(repositoryClass="BZ\ModelBundle\Repository\AdversairePhysiqueRepository")
 *  @ORM\HasLifecycleCallbacks()
 */
class AdversairePhysique extends PersonnePhysique
{
