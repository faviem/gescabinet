<?php
// src/BZ/ModelBundle/Entity/PieceAudience.php
...
/**
* BZ\ModelBundle\Entity\PieceAudience
*
* @ORM\Table(name="pieceaudience")
* @ORM\Entity(repositoryClass="BZ\ModelBundle\Repository\PieceAudienceRepository")
...
class PieceAudience
{
      ...
      /**
    * @ORM\ManyToOne(targetEntity="BZ\ModelBundle\Entity\TacheAudience", inversedBy="pieceaudiences")
...
//            $this->removeUpload();
    ...
    //            $this->setFile($file);
            ...
            // Et on génère l'attribut alt de la balise <PieceAudience>, à la valeur du nom du fichier sur le PC de l'internaute
        ...
        */
        ...
        {
        return 'uploads/PieceAudience/'.$this->getId().'.'.$this->getUrl();
        }
        /**
